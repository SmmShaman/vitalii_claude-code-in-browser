...
export const PALETTES: ColorPalette[] = [
  {
    ...
    light: {
      ...
      '--text-muted': '100 98 115',
      '--text-faint': '130 127 148',
      '--accent-brand': '10 120 110',
      '--accent-brand-light': '12 100 92',
  ...
  },
  {
    ...
    light: {
      ...
      '--text-muted': '65 95 130',
      '--text-faint': '95 122 155',
      '--accent-brand': '6 115 142',
      '--accent-brand-light': '10 95 120',
  ...
  },
  {
    ...
    light: {
      ...
      '--text-muted': '55 55 85',
      '--text-faint': '85 85 118',
      '--accent-brand': '4 110 138',
      '--accent-brand-light': '5 90 115',
      '--accent-brand-lighter': '22 78 99',
  ...
  },
  {
    ...
    light: {
      ...
      '--text-muted': '110 75 90',
      '--text-faint': '140 105 120',
      '--accent-brand': '190 24 62',
      '--accent-brand-light': '160 15 52',
