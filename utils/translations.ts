export const translations = {
  en: {
    ...
    about_content: "I'm not a programmer. I'm a person who solves problems using AI.\n\nWhen I was job hunting in Norway, I spent 3 hours every day browsing vacancies.\nSo I built JobBot — a system that does it in 5 minutes.\n\n47 vacancies → 12 relevant → 5 personalized cover letters.\n5 minutes instead of 3 hours. Savings: 15 hours per week.\n\nNow I help others:\n• MVPs for startups in 2-4 weeks — without million-dollar budgets\n• Automation of processes that eat up your time\n• AI integrations into existing systems\n\nMy success criteria? When a client says:\n\"This saved me 3 hours today.\"\n\nApproach: Production, not demo. Results, not technologies.\nFast iterations, minimum bureaucracy.\n\nTech stack: React, TypeScript, Python, Supabase, Azure OpenAI, n8n.\n\n📍 Based in Norway. Working with clients worldwide.\n\nSpending hours on things that can be automated? Let's talk.",
  ...
  no: {
    ...
    about: "Om meg",
    about_title: "Om meg",
    about_content: "Jeg er ikke programmerer. Jeg er en person som løser problemer ved hjelp av AI.\n\nDa jeg søkte jobb i Norge, brukte jeg 3 timer hver dag på å se gjennom stillingsannonser.\nDerfor bygde jeg JobBot — et system som gjør det på 5 minutter.\n\n47 stillinger → 12 relevante → 5 personaliserte søknadsbrev.\n5 minutter i stedet for 3 timer. Besparelse: 15 timer per uke.\n\nNå hjelper jeg andre:\n• MVP for startups på 2-4 uker — uten millionbudsjetter\n• Automatisering av prosesser som spiser opp tiden din\n• AI-integrasjoner i eksisterende systemer\n\nMitt suksesskriterium? Når en kunde sier:\n«Dette sparte meg 3 timer i dag.»\n\nTilnærming: Produksjon, ikke demo. Resultater, ikke teknologier.\nRaske iterasjoner, minimum byråkrati.\n\nTeknologier: React, TypeScript, Python, Supabase, Azure OpenAI, n8n.\n\n📍 Basert i Norge. Jobber med kunder over hele verden.\n\nBruker du timer på ting som kan automatiseres? La oss snakke.",
  ...
  ua: {
    ...
    about_content: "Я не програміст. Я — людина, яка вирішує проблеми за допомогою AI.\n\nКоли шукав роботу в Норвегії, витрачав 3 години щодня на перегляд вакансій.\nТому побудував JobBot — систему, яка робить це за 5 хвилин.\n\n47 вакансій → 12 релевантних → 5 персоналізованих листів.\nЗа 5 хвилин замість 3 годин. Економія: 15 годин на тиждень.\n\nТепер допомагаю іншим:\n• MVP для стартапів за 2-4 тижні — без мільйонних бюджетів\n• Автоматизація процесів, що з'їдають ваш час\n• AI-інтеграції в існуючі системи\n\nМій критерій успіху? Коли клієнт каже:\n«Це зекономило мені 3 години сьогодні.»\n\nПідхід: Production, не демо. Результат, не технології.\nШвидкі ітерації, мінімум бюрократії.\n\nТехнології: React, TypeScript, Python, Supabase, Azure OpenAI, n8n.\n\n📍 Базуюсь в Норвегії. Працюю з клієнтами по всьому світу.\n\nВитрачаєте години на те, що можна автоматизувати? Давайте поговоримо.",
