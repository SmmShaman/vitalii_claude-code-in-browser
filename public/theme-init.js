...
(function () {
  try {
    ...
    var neutralLight = {
      ...
      '--text-muted': '110 108 125', '--text-faint': '155 152 170',
      '--accent-brand': '13 148 136', '--accent-brand-light': '15 118 110',
    ...
    var darkPalettes = {
      'deep-ocean': {
        ...
        '--accent-brand': '8 145 178', '--accent-brand-light': '34 211 238',
        '--accent-brand-lighter': '125 211 252', '--accent-brand-dark': '14 116 144',
        '--accent-brand-darker': '22 78 99',
        '--focus-ring': '34 211 238', '--focus-ring-dark': '125 211 252',
    ...
    var lightPalettes = {
      'deep-ocean': {
        ...
        '--text-muted': '80 110 145', '--text-faint': '120 148 178',
        '--accent-brand': '8 145 178', '--accent-brand-light': '14 116 144',
      ...
      'cyber-neon': {
        ...
        '--text-muted': '70 70 100', '--text-faint': '110 110 140',
        '--accent-brand': '6 182 212', '--accent-brand-light': '8 145 178',
      ...
      'midnight-rose': {
        ...
        '--text-muted': '125 90 105', '--text-faint': '165 130 145',
        '--accent-brand': '225 29 72', '--accent-brand-light': '190 18 60',
