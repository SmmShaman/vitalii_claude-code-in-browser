...
## ✅ Крок 2: Додати Бота як Адміна Каналу

### У Telegram:

1. Відкрийте канал **@geekneural**

2. **Subscribers** → **Add Administrator**

3. Пошукайте вашого бота

4. **Додайте** з мінімальними правами (можна навіть без прав!)

### Що відбувається:
```
Новий пост в @geekneural
        ↓
Telegram автоматично надсилає update боту
        ↓
Бот перевіряє: "Чи є @geekneural в news_sources?"
        ↓
Якщо ТАК і is_active = true → Обробити
Якщо НІ або is_active = false → Пропустити
```
