...
- 1-3 речення (max 200 символів)
- Описує ключову візуальну концепцію статті
- Використовує описову, візуальну мову
- Включає стильові підказки (напр. "modern illustration", "professional graphic")
- БЕЗ тексту на зображенні

**Приклади:**

| Стаття | Згенерований промпт |
|--------|---------------------|
| "Meta Unveils SAM Audio" | Professional illustration of audio waveforms transforming into colorful AI neural networks, modern tech style |
| "Scientists Discover New Exoplanet" | Artistic rendering of a blue-green Earth-like planet with two suns in the background, space illustration style |
| "AI Tool Helps Doctors Diagnose" | Clean medical illustration showing AI brain analyzing patient data on futuristic holographic displays |
