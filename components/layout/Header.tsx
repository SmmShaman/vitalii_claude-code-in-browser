            ...
            <button
              ...
              className={`relative z-10 p-2 rounded-lg transition-all duration-300 ${
                searchQuery.trim()
                  ...
                  : searchOpen
                    ? 'bg-[#221F3A] text-[#EEEDF5]'
                    : 'bg-[#1A1730]/70 text-[#9B97B0] hover:bg-[#221F3A]'
              }`}
              aria-label="Search"
            >
          ...
          {languages.map((lang) => (
            <button
              ...
              className={`flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 rounded-md transition-all duration-300 ${
                currentLanguage === lang
                  ? 'bg-[#221F3A]/80 text-[#EEEDF5] border border-[#3D3960]'
                  : 'bg-[#1A1730]/70 text-[#C8C5D6] hover:bg-[#221F3A] hover:text-[#EEEDF5] border border-[#2D2A40]'
              }`}
