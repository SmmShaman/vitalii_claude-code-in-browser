    ...
    <footer className="h-full w-full flex items-center overflow-y-auto">
      <div
        ...
        style={isMobile ? {
          ...
          background: 'linear-gradient(160deg, rgba(20, 10, 30, 0.90) 0%, rgba(30, 15, 50, 0.93) 50%, rgba(15, 8, 25, 0.91) 100%)',
          backdropFilter: 'blur(20px) saturate(1.2)',
          WebkitBackdropFilter: 'blur(20px) saturate(1.2)',
          border: '1px solid rgba(139, 92, 246, 0.12)',
          boxShadow: '0 -1px 0 rgba(139, 92, 246, 0.08), 0 12px 40px rgba(0, 0, 0, 0.4)',
        }}
      >
