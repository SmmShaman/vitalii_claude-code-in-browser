  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
        <h3 className="text-white font-semibold mb-2">Automatic Monitoring:</h3>
        <ul className="text-gray-300 text-sm space-y-1">
          <li>- Telegram channels: Add bot as admin for automatic posts</li>
          <li>- RSS feeds: Automatic fetch every hour (configurable)</li>
          <li>- Activate/Deactivate: Just click toggle - no code!</li>
          <li>- Bot only monitors ACTIVE sources from this list</li>
        </ul>
      </div>
        ...
        <div className="flex gap-3 items-end">
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-400 mt-1">
              Example: @geekneural or https://t.me/geekneural
            </p>
          </div>
          <motion.button
            whileHover={{ scale: 1.05 }}
