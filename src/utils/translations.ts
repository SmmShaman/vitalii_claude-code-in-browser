export const translations = {
  en: {
    title: "Vitalii Berbega, an expert in e-commerce and marketing",
  ...
  no: {
    title: "Vitalii Berbega, en ekspert innen e-handel og markedsføring",
  ...
  ua: {
    ...
    about_content: "Детальна інформація про мене\n\nЯ **Віталій Бербега** — керівник AI-проєктів та підприємець, який поєднує понад 20 років досвіду в розвитку бізнесу з сучасними технологіями штучного інтелекту. Спеціалізуюся на створенні інноваційних EdTech рішень та автоматизації бізнес-процесів.\n\n**Мій флагманський проєкт — Elvarika** — революційна SaaS-платформа для вивчення мов, яка використовує персоналізовані аудіоплейлисти та AI-алгоритми. Застосунок поєднує B2B та B2C підходи, пропонуючи індивідуальні траєкторії навчання на основі аналізу даних користувачів. Від концепції до реалізації я провів повний цикл розробки: дослідження ринку, системна архітектура, програмування (React/TypeScript, Supabase), локалізація та стратегія виходу на ринок.\n\n**Технічна експертиза:** Azure OpenAI, React, TypeScript, Python (FastAPI), Supabase, автоматизація через Zapier/Make. Досвід інтеграції AI в реальні бізнес-процеси — від чат-ботів до прогнозної аналітики.\n\n**Підприємницький досвід:** За плечима успішне керівництво власною компанією (2007-2017), запуски продуктів на Amazon Marketplace в США та Європі, розробка стратегій виходу на норвезький ринок. Працював з компаніями від стартапів до корпорацій, спеціалізуючись на цифровій трансформації та масштабуванні бізнесу.\n\n**Освіта та локалізація:** Магістерський ступінь з педагогіки з математикою та економікою. Вільно володію українською, норвезькою, англійською та російською мовами. Базуюся в Норвегії, де активно розвиваю EdTech-ініціативи та консультую місцеві компанії з питань інтеграції AI.\n\n**Моя місія:** Створювати технологічні рішення, які роблять навчання та бізнес-процеси більш ефективними, персоналізованими та доступними для глобальної аудиторії.\n\nМої спеціалізації:\n\n• Розробка та інтеграція AI-рішень\n• Автоматизація бізнес-процесів\n• Аналіз даних та BI-рішення\n• Веб-розробка та UX/UI дизайн\n• Консалтинг цифрової трансформації",
