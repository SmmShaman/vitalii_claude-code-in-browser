  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
        <h3 className="text-white font-semibold mb-2">✨ Автоматичний Моніторинг:</h3>
        <ul className="text-gray-300 text-sm space-y-1">
          <li>• 🤖 <strong>Telegram канали:</strong> Додайте бота як адміна → автоматичні пости</li>
          <li>• 📰 <strong>RSS feeds:</strong> Автоматичний fetch кожну годину (налаштовується)</li>
          <li>• ✅ <strong>Активація/Деактивація:</strong> Просто натисніть toggle - без коду!</li>
          <li>• 🔍 Бот моніторить ТІЛЬКИ активні джерела з цього списку</li>
        </ul>
      </div>
      ...
      <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-4">
        ...
        <div className="flex gap-3 items-end">
          <div className="flex-1">
            <input
              type="text"
              placeholder="@channel_username або https://t.me/channel_username"
              ...
              id="quick-telegram-input"
            />
            <p className="text-xs text-gray-400 mt-1">
              Приклад: @geekneural або https://t.me/geekneural
            </p>
          </div>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            onClick={() => {
              const input = document.getElementById('quick-telegram-input') as HTMLInputElement;
            ...
            className="px-6 py-2 bg-cyan-600 hover:bg-cyan-700 text-white rounded-lg transition-colors whitespace-nowrap"
          >
            Додати
          </motion.button>
        </div>
